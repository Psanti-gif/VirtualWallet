...
peticionPost = async () => {
  ...
  await axios.post('http://localhost:4001/api/usuarios/registro', this.state.form)
      .then(response => {
        alert(`Bienvenido`)
              ...
              <form class="mb-5 ml-0 align-items-button ">
                <div class="d-flex justify-content-arounds">
                  <div class="mb-1 w-100">
                    ...
                    <input type="text" class="form-control bg-dark-x text-light" placeholder='Ingresa tu nombre' id="txtnom" aria-describedby="emailHelp" onChange={this.handleChange} name='nombre'/>

                  </div>

                  <div class="mb-1 w-100">
                    <label for="exampleInputName" class="form-label label font-weight-bold ">Apellido </label>
                    <input type="text" class="form-control bg-dark-x text-light " placeholder='Ingresa tu apellido' id="txtape" aria-describedby="nameHelp" onChange={this.handleChange} name='apellido'/>
                  </div>
                ...
                <div class="mb-1">
                  ...
                  <input type="email" class="form-control bg-dark-x text-light " placeholder='Ingresa tu email' id="txtema" aria-describedby="emailHelp" onChange={this.handleChange} name='correo'/>
                </div>

                <div class="mb-1">
                  <label for="exampleInputEmail1" class="form-label label font-weight-bold ">Numero de telefono </label>
                  <input type="number" class="form-control text-light bg-dark-x" placeholder='Ingresa tu nomero de telefono' id="txttel" onChange={this.handleChange} name='telefono'  aria-describedby="emailHelp" />
                </div>
                ...
                <div class="d-flex justify-content-arounds">
                  ...
                  <div class="mb-1 w-100">
                    ...
                    <input type="password" class="form-control bg-dark-x text-light mb-2" placeholder='Ingresa tu contraseña' id="txtpas" onChange={this.handleChange} name='contraseña'/>
                  </div>

                  <div class="mb-4 w-100 ">
                    <label for="exampleInputPassword1" class="form-label label font-weight-bold ">Confirmar contraseña</label>
                    <input type="password" class="form-control text-light bg-dark-x  mb-2" placeholder='Ingresa tu contraseña de nuevo' id="txtcpas" onChange={this.handleChange} name='confirmarContraseña'/>
                  </div>

                </div>

                  <button type="submit" class="btn btn-primary w-100 form-control altura mb-0"onClick={() => this.peticionPost()} >Registrarme</button>
