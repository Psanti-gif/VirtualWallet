...
function Login() {
  ...
  return (
    <div class="MiLogin">
      <section class="row bg-dark-dark body noscrollx" id="Login">
            ...
            <div class="carousel-inner">
              <div class="carousel-item img-1 min-vh-100 active">
                <div class="carousel-caption d-none d-md-block">
                  ...
                  <Link to="/tyc" class="tex-muted text-light">
        ...
        <div class="col-lg-5 d-flex flex-column minh align-items-end max-vh-100 mb-auto">
          <div class="px-lg-5 py-lg-4 p-4 pt-0  w-100 noscrollx ">
            ...
            <form class="mb-5 " style={{ maxWidth: "100vh " }}>
              <div class="d-flex justify-content-arounds"></div>
              <div class="mb-2">
                <label
                  for="exampleInputEmail1"
                  class="form-label label font-weight-bold "
                >
                  Email
                </label>
                <input
                  type="email"
                  class="form-control bg-dark-x text-light ml-0"
              ...
              <div class="mb-2">
                ...
                <input
                  type="nomber"
                  class="form-control text-light label bg-dark-x"
              ...
              <div class="mb-5">
                ...
                <input
                  type="password"
                  class="form-control text-light bg-dark-x  mb-2"
              ...
              <button
                type="submit"
                class="btn btn-primary w-100 form-control altura mb-0"
            ...
            <div class="text-center w-100 mt-0">
              <p class="d-inline-blockh mb-0 ">
                ¿Todavia no tienes una cuenta?
              </p>{" "}
              <Link to="/registro" class="text-light font-weight-bold">
                Registrate ahora
              </Link>
            </div>
          </div>
